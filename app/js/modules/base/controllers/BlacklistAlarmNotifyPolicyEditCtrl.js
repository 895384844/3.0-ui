define(
	function () {
		return ['$scope', 'HttpService', 'title','userInfo','close', BlacklistAlarmNotifyPolicyEditCtrl];
		function BlacklistAlarmNotifyPolicyEditCtrl($scope, HttpService,title, userInfo,close) {

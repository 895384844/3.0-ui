define(
	function () {
		return ['$scope', 'HttpService', 'title','userInfo','close', DeviceAlarmNotifyPolicyFormCtrl];
		function DeviceAlarmNotifyPolicyFormCtrl($scope, HttpService,title, userInfo,close) {
